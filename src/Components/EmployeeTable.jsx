        ...
        return (
            <div className="bg-white p-4 sm:p-6 lg:p-8 rounded-lg border-2 border-blue-100">
                <div className="text-center py-6 sm:py-8">
                    ...
                    <h3 className="text-base sm:text-lg font-semibold text-gray-800 mb-2">Error Loading Employees</h3>
            ...
            <div className="bg-white rounded-lg border-2 border-blue-100 overflow-hidden">
                ...
                <div className="px-4 sm:px-6 py-3 sm:py-4 border-b border-blue-200 bg-blue-50">
                    <div className="flex items-center justify-between">
                        <div>
                            <h2 className="text-lg sm:text-xl font-semibold text-gray-800">Employee Directory</h2>
                ...
                {employees.length === 0 ? (
                    <div className="text-center py-12 sm:py-16 px-4 sm:px-6">
                        <div className="w-16 h-16 sm:w-24 sm:h-24 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
                                    ...
                                    <tr key={employee.id} className="hover:bg-blue-50 transition-colors">
                                        <td className="px-3 sm:px-4 lg:px-6 py-3 sm:py-4 whitespace-nowrap">
                                            <div className="flex items-center">
                                                <div className="h-8 w-8 sm:h-10 sm:w-10 bg-blue-500 rounded-full flex items-center justify-center">
                                        ...
                                        <td className="px-3 sm:px-4 lg:px-6 py-3 sm:py-4 whitespace-nowrap text-sm font-medium">
                                            <div className="flex items-center space-x-1 sm:space-x-2 lg:space-x-3">
                                                <button
                                                    ...
                                                    className="text-blue-600 hover:text-blue-800 transition-colors p-1 sm:p-2 rounded hover:bg-blue-100 border border-blue-200"
                                                    title="Edit employee"
                                                >
