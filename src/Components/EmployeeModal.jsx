    ...
    return (
        <div className="fixed inset-0 z-50 overflow-y-auto">
            <div className="flex items-center justify-center min-h-screen px-3 sm:px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div
                    className="fixed inset-0 transition-opacity backdrop-blur-sm bg-white/10 bg-opacity-50"
                            ...
                            <form onSubmit={handleSubmit(onSubmit)} className="space-y-3 sm:space-y-4">
                                ...
                                <div className="flex space-x-2 sm:space-x-3 pt-2 sm:pt-4">
                                    <button
                                        ...
                                        className="flex-1 bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-3 sm:py-2 sm:px-4 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-50 transition-colors flex items-center justify-center border border-blue-700 text-sm sm:text-base"
                                    >
                                        {isSubmitting ? (
                                            <>
